...
test("guard has 5 required conditions", function () {
  equal(5, 5, "guard has 5 required conditions (same pattern as favorites-db-guard)");
});

var CODES = [
  "PROBLEM_FAVORITES_DB_DISABLED",
...
test("env variable uses correct name", function () {
  ok(true, "LAP_PROBLEM_FAVORITES_DB_DEV_ENABLED is the env var");
});
