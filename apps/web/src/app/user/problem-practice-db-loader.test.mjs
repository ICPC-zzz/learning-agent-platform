/**
 * Problem Practice DB Loader Tests — standalone JS tests.
...
test("problem-practice-db-loader.ts file exists", function () {
  var path = resolve(__dirname, "problem-practice-db-loader.ts");
...
test("loader file exports loadDbProblemPractice", function () {
  var source = readFileSync(resolve(__dirname, "problem-practice-db-loader.ts"), "utf-8");
  ok(source.indexOf("loadDbProblemPractice") >= 0, "should export loadDbProblemPractice");
});

test("loader file uses PrismaProblemPracticeRepository", function () {
  var source = readFileSync(resolve(__dirname, "problem-practice-db-loader.ts"), "utf-8");
...
test("loader file returns useDbPractice field", function () {
  var source = readFileSync(resolve(__dirname, "problem-practice-db-loader.ts"), "utf-8");
  ok(source.indexOf("useDbPractice") >= 0, "should return useDbPractice");
});
...
test("loader file has getProblemPracticeDbGuardEnabled helper", function () {
  var source = readFileSync(resolve(__dirname, "problem-practice-db-loader.ts"), "utf-8");
  ok(source.indexOf("getProblemPracticeDbGuardEnabled") >= 0,
    "should export getProblemPracticeDbGuardEnabled");
});
...
test("loader maps status field", function () {
  var source = readFileSync(resolve(__dirname, "problem-practice-db-loader.ts"), "utf-8");
  ok(source.indexOf("status") >= 0, "should map status field");
});
